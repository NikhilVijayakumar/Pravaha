"""
JSON Workflow Config Repository

Default JSON file-based implementation of WorkflowConfigRepositoryProtocol.
"""
...
from pravaha.domain.workflow.protocol.workflow_config_repository_protocol import WorkflowConfigRepositoryProtocol
from pravaha.domain.config.cache_config import CachePathConfig


class JsonWorkflowConfigRepository(WorkflowConfigRepositoryProtocol):
    """
    JSON file-based workflow config repository.
    
    Stores workflow paths in JSON file with get/update operations.
    """
    ...
    def __init__(self, cache_config: Optional[CachePathConfig] = None):
        ...
        self.config_dir = Path.cwd() / cache_config.get_workflow_cache_dir()
